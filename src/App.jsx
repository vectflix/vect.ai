...
const App = () => {
  ...
  const handleGenerate = async () => {
    ...
    setActiveTab('code');
    try {
      const res = await fetch('https://vect-ai-engine.onrender.com/api/generate', {
        method: 'POST',
      ...
      setGeneratedCode("/* PEAK_ERROR: Engine waking up. Retry in 20s. */");
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-7xl mx-auto peak-grid-container">
        <div className="lg:col-span-4 glass p-6 rounded-[2.5rem] flex flex-col gap-6">
          <div className="flex justify-between items-center">
            ...
            <i onClick={() => setShowSettings(true)} className="fas fa-sliders-h cursor-pointer text-white"></i>
          </div>
          <textarea 
            value={prompt}
        ...
        <div className="lg:col-span-8 glass rounded-[2.5rem] overflow-hidden flex flex-col min-h-[500px]">
          ...
          <div className="flex-1 bg-[#020205] p-6 overflow-auto">
            {activeTab === 'preview' ? (
