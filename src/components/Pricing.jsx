...
const Pricing = ({ isOpen, onClose, onUpgrade }) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div className="glass max-w-sm w-full p-8 rounded-[3rem] text-center relative">
        ...
        <p className="text-gray-400 text-sm mb-8">Unlock unlimited generations and the Peak Engine Ultra.</p>
        <button onClick={onUpgrade} className="w-full py-4 bg-white text-black rounded-2xl font-black uppercase hover:bg-purple-500 hover:text-white transition">Upgrade to Pro</button>
      </div>
    </div>
  );
};
